    ...
    <div class="d-flex">
        ...
        >
            <template #prepend-item>
                <v-btn-toggle
                    ...
                    variant="outlined"
                >
                    <v-btn value="-1">{{ t('filter.input') }}</v-btn>
                    <v-btn value="0">{{ t('filter.all') }}</v-btn>
                    <v-btn value="1">{{ t('filter.output') }}</v-btn>
                </v-btn-toggle>
            </template>
        ...
        >
            <template #prepend-item>
                ...
                <v-list-item :title="t('filter.groupBy')" @click="(filter.groupTier = !filter.groupTier)">
                    <template #prepend>
