...
<template>
    <v-dialog v-model="dialog">
        <v-sheet>
            <v-toolbar>
                <v-toolbar-title>{{ t('share.loadBlueprint') }}</v-toolbar-title>
                <v-spacer />
                <v-btn
                    :icon="mdiClose"
                    @click="dialog = false"
                ...
                <div class="my-flex-xs-wrap mb-4">
                    <div class="flex-grow-1 mr-1 mt-2">
                        <v-textarea
                            ...
                            :label="t('share.pasteBlueprintData')"
                            variant="outlined"
                            hide-details
                        />
                    </div>
                    <div class="mt-2">
                        <v-btn
                            ...
                            @click="paste()"
                        >{{ t('share.pasteFromClipboard') }}</v-btn>
                        <v-btn
                            block
                            size="small"
                            color="secondary"
