...
<template>
    <v-dialog v-model="dialog" width="auto">
        <v-card>
            <v-toolbar>
                <v-toolbar-title>
                    <div class="d-flex align-center">
                        ...
                        <div class="pl-2">{{ t('about.title') }}</div>
                    </div>
                </v-toolbar-title>
                <v-spacer />
                <v-btn
            ...
            <v-card-subtitle>{{ t('about.description') }}</v-card-subtitle>
            <v-card-subtitle>{{ t('about.by') }}<v-icon :icon="mdiEmail" /><a href="mailto:dax@xdax.ru" target="_blank">dax@xdax.ru</a>,
                <a href="https://github.com/doubleaxe" target="_blank">https://github.com/doubleaxe</a>)
            </v-card-subtitle>
            <!-- Added by Marvis: credit for translation / secondary development -->
            <v-card-subtitle>{{ t('about.reworkedBy') }}<a href="https://github.com/htpgc" target="_blank">https://github.com/htpgc</a>)</v-card-subtitle>
            <v-card-text>
                <v-list :lines="undefined">
                    <v-list-item :title="t('about.game')">
                    ...
                    <v-list-item :title="t('about.gameVersion')" :subtitle="gameDescription.version" />
                    <v-list-item :title="t('about.buildVersion')" :subtitle="__VERSION__" />
                    <v-list-item :title="t('about.buildTime')" :subtitle="__BUILD_TIME_STR__" />
                    <v-list-item :title="t('about.changeLog')">
                        <v-list-item-subtitle>
                    ...
                    <v-list-item :title="t('about.bugReports')">
                        <v-list-item-subtitle>
